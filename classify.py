...
class NaiveBayesClassifier(object):
    ...
    def get_features(self, document):
        ...
        all_words = [w for w in word_tokenize(document) if len(w) > 3 and len(w) < 16] # throw away words 3 characters or less
        p = PorterStemmer() # reducing words to root
    ...
    def feature_prob(self, f, category):
...
if __name__ == '__main__':
    ...
    print ( nb.probability("team busters won the soccer gold cup", 'sports'))
    print ( nb.probability("team busters won the soccer gold cup", 'arts'))
